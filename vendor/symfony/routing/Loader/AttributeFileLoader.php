...
class AttributeFileLoader extends FileLoader
{
    ...
    protected function findClass(string $file): string|false
    {
        ...
        if (1 === \count($tokens) && \T_INLINE_HTML === $tokens[0][0]) {
            throw new \InvalidArgumentException(sprintf('The file "%s" does not contain PHP code. Did you forget to add the "<?php
 
" start tag at the beginning of the file?', $file));
        }
