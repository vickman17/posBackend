 ...
 *
 * Most notably, this file usually contains an entry to map "localhost:3306" to the
 * local IP. Windows is a notable exception here, as Windows does not actually
 * include "localhost:3306" in this file by default. To compensate for this, this
